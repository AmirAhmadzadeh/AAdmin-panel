            ...
            <nav className="header__navigation">
                <div className="header__navigation--button-brand">
                    <MenuIcon
                        ...
                        className="header__navigation--menuButton"
                    />
                </div>
                <div className="header__navigation--profile">
                    <Fab className="header__fab">
                        <Icon
                            IconName="headerHumanIcon"
                            classes="header__icon" />
                    </Fab>
                    <Fab className="header__fab">
                        <Icon
                            IconName="headerNotification"
                            classes="header__icon" />
                    </Fab>
                    <Fab className="header__fab">
                        <Icon
                    ...
                    <Fab className="header__fab header__fab--search">
                        <Icon
                            IconName="headerSearch"
                            classes="header__icon header__icon--search" />
                    </Fab>
                    <TextField
                        id="input-with-icon-grid"
                        label="Search"
                        className="header__search-textField"
                    />
                </div>
            </nav>
        </header>
